/** 
 * Це javascript файл для вправи "IPUT_type"/"Введи"
 * Даний вид вправ іде під номером .6 (Наприклад 5.6, 6.6 чи 25.6)
 * Текстовий файл з завданням повинен називатися так як і файл *.html 
 * Наприклад для Exercise_5.6.html тектовий файл повинен бути Exercise_5.6.txt
 * Файл з режимом вчителя для Exercise_5.6.html повинен бути Exercise_5.6-tm.html
 * 
...
//наприклад для завдання 8.6 простий виклик буде: /Exercise_8.6.html режим вчителя: /Exercise_8.6-tm.html
...
function setUpPage() {
  ...
  document.write("<div class='row justify-content-center lead text-center text-muted m-1'>" + eval("question" + (8))[0] + "&nbsp;&nbsp;--->&nbsp;&nbsp;" + eval("question" + (8))[1] + "</div>");

   for (k = 3; k < 10; k++) {
    //блок запису завдання
    document.write(
      "<div class='row justify-content-center lead text-start text-muted m-1'>" +
        "<div class='col-9 text-start m-1 p-1'>" +
        (k-2) + ".&nbsp;" +
        eval("question" + (k-2))[0] +
        "&nbsp;&nbsp;&nbsp;<input type='text' class='exercise_inputbox' size='60%' name='rb" +
        (k-2) + "'>&nbsp;" +        
        eval("question" + (k-2))[2]);
