/** 
 * Це javascript файл для вправи "MISS_type"/"Введи пропущене дієслово"
 * Даний вид вправ іде під номером .4 (Наприклад 5.4, 6.4 чи 25.4)
 * Текстовий файл з завданням повинен називатися так як і файл *.html 
 * Наприклад для Exercise_5.4.html тектовий файл повинен бути Exercise_5.4.txt
 * Файл з режимом вчителя для Exercise_5.4.html повинен бути Exercise_5.4-tm.html
 * 
...
//наприклад для завдання 8.4 простий виклик буде: /Exercise_8.4.html режим вчителя: /Exercise_8.4-tm.html
...
var response;
(function () {
  var xmlhttp = getXmlHttp();   //xmlhttp.open("GET", "Exercise_8.4.txt", false);
